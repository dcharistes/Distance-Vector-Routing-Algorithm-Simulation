function [ Final_Cost_Matrix ] = Routing_Process( Cost_Matrix, Delay_Matrix, Update_Period, Failure_Time, Recovery_Time )
...
function [ Event_List, Cost_Matrix, Next_Hop, Router_Flags ] = Event2 ( Event_List, Time, Number_Routers, Cost_Matrix, Next_Hop, Router_Flags )
    ...
    for counter=1:Number_Routers
        ...
        Router_Flags(1,Event_List(5,1))=flag;
...
function [ Event_List, Neighbors, Cost_Matrix, Next_Hop, Recovery_Record ] = Event6 ( Time, Event_List, Neighbors, Cost_Matrix, Next_Hop, Recovery_Record )
